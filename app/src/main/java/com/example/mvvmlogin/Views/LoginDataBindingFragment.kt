...
import com.example.mvvmlogin.Listeners.MyListener
...
class LoginDatabindingFragment:Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val loginBinder : LoginFragmentBinding  = DataBindingUtil.inflate(inflater,
            R.layout.login_data_binding,container,false)
